...
public class FindNearestScene4 : MonoBehaviour {
    ...
    public void Update() {
        ...
        var sortJob = _targetPositions.SortJob(new AxisXComparer());
        var sortJobHandle = sortJob.Schedule();

        // To schedule a job, we first need to create an instance and populate its fields.
        EnhancedFindNearestParallelJob findJob = new EnhancedFindNearestParallelJob {
        ...
        JobHandle findHandle = findJob.Schedule(_seekerPositions.Length, 500, sortJobHandle);
